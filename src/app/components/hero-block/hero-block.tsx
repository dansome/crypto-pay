                            ...
                            <div className={styles.bots}>
                                <div className={styles.heroBlock__botsPhotos}>
                                    <div className={styles.heroBlock__bot}>
                                        <Image fill={true} alt="Ellipse" src="/png/bots/Ellipse 1.png" />
                                    </div>
                                    <div className={styles.heroBlock__bot}>
                                        <Image fill={true} alt="Ellipse" src="/png/bots/Ellipse 2.png" />
                                    </div>
                                    <div className={styles.heroBlock__bot}>
                                        <Image fill={true} alt="Ellipse" src="/png/bots/Ellipse 3.png" />
                                    </div>
                                    <div className={styles.heroBlock__bot}>
                                        <Image fill={true} alt="Ellipse" src="/png/bots/Ellipse 4.png" />
                                    </div>
                                    <div className={styles.heroBlock__bot}>
                                        <Image fill={true} alt="Ellipse" src="/png/bots/Ellipse 5.png" />
                                    </div>
                                </div>
